...
: "${D3_ROBOT_CODE:=dingsshadsm8rt5h7ruv}"
: "${D3_NOTIFY_GROUP:=cid5wfiNs3aPtM7DpL050FRUQ==}"
: "${D3_DEFAULT_AT_USER:=216162182424059334}"
: "${D3_ATABLE_BASE:=jb9Y4gmKWrALBykmTe2A2g3l8GXn6lpz}"
: "${D3_TABLE_AUDIT:=OQwqwXj}"
: "${D3_TABLE_BUDAN:=hERWDMS}"
: "${D3_TABLE_SHORTAGE:=8FWt8wz}"
: "${D3_TABLE_STAFF:=y89Wute}"
